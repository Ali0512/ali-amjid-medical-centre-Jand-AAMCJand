    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Formula_Medicines", x => new { x.formulaId, x.medicineID });
                    table.ForeignKey(
                        name: "FK_Formula_Medicines_Formulas_formulaId",
                        column: x => x.formulaId,
                        principalTable: "Formulas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Formula_Medicines_Medicines_medicineID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Formula_Medicines_medicineID",
                table: "Formula_Medicines",
                column: "medicineID");
